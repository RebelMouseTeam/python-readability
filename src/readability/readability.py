...
REGEXES = {
    'unlikelyCandidatesRe': re.compile('combx|comment|community|disqus|extra|foot|header|menu|remark|rss|shoutbox|sidebar|lateral|sponsor|ad-break|agegate|pagination|pager|popup|tweet|twitter', re.I),
